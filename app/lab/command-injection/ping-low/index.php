...
if(isset($_POST["submit"])) {
    $target_dir = "uploads/";
    $file_name = basename($_FILES["image"]["name"]); // Get the basename of the uploaded file
    $target_file = $target_dir . $file_name; // Construct the target file path
    $uploadOk = 1;
    $imageFileType = strtolower(pathinfo($file_name, PATHINFO_EXTENSION)); // Get the file extension
